			...
			<body>
				<div id="sitemap">
					<div id="sitemap__header">
						...
						<p>Bu XML site haritası, içeriğinizi arama motorları için daha görünür kılmak amacıyla WordPress tarafından oluşturulur.</p>
						<p><a href="https://www.sitemaps.org/">Site haritaları hakkında ayrıntılı bilgi alın.</a></p>
					</div>
					<div id="sitemap__content">
						<p class="text">Bu XML site haritasındaki site adresi sayısı: <xsl:value-of select="count( sitemap:sitemapindex/sitemap:sitemap )" />.</p>
